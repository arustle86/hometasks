...
$comments_text   = sprintf( _n( '%s Комментариев', '%s Комментариев', $comments_number, 'metro' ), number_format_i18n( $comments_number ) );
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post-each post-each-1' ); ?>>
	...
	<div class="post-content-area">
		...
		<a href="<?php the_permalink();?>" class="read-more-btn"><?php esc_html_e( 'Читать далее', 'metro' );?><i class="fa fa-arrow-right" aria-hidden="true"></i></a>		
	</div>
</article>