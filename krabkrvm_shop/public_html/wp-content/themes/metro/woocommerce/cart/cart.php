	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-name"><?php esc_html_e( 'Продукт', 'metro' ); ?></th>
				<th class="product-price"><?php esc_html_e( 'Цена', 'metro' ); ?></th>
				<th class="product-quantity"><?php esc_html_e( 'Количество', 'metro' ); ?></th>
				<th class="product-subtotal"><?php esc_html_e( 'Сумма', 'metro' ); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr class="cart-action">
				<td colspan="6" class="actions">
					...
					<button type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Пересчитать', 'metro' ); ?>"><?php esc_html_e( 'Пересчитать', 'metro' ); ?></button>
